...
PROJECT_SOURCE_FILES  ?= \
    $(shell D:/coding/tools/w64devkit/bin/find.exe src -type f -name "*.c")

# raylib library variables
RAYLIB_SRC_PATH       ?= D:/coding/libs/raylib/src
...
COMPILER_PATH         ?= D:/coding/tools/w64devkit/bin
...
BUILD_WEB_HEAP_SIZE   ?= 512MB
BUILD_WEB_STACK_SIZE  ?= 1MB
BUILD_WEB_ASYNCIFY_STACK_SIZE ?= 1MB
...
ifeq ($(PLATFORM_OS),WINDOWS)
    ifeq ($(PLATFORM),PLATFORM_WEB)
        ...
        EMSDK_PATH         ?= D:/coding/tools/emsdk

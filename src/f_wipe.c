...
void wipe_shittyColMajorXform(d_short *array, d_int width, d_int height) {
    d_int x;
    d_int y;
    d_short *dest;
...
d_int wipe_initColorXForm(d_int width, d_int height, d_int ticks) {
    memcpy(wipe_scr, wipe_scr_start, width * height);
    return 0;
}

d_int wipe_doColorXForm(d_int width, d_int height, d_int ticks) {
    boolean changed;
    byte *w;
    byte *e;
    d_int newval;
...
d_int wipe_exitColorXForm(d_int width, d_int height, d_int ticks) {
    return 0;
}

static d_int *y;

d_int wipe_initMelt(d_int width, d_int height, d_int ticks) {
    d_int i, r;
...
d_int wipe_doMelt(d_int width, d_int height, d_int ticks) {
    d_int i;
    d_int j;
    d_int dy;
    d_int idx;
...
d_int wipe_exitMelt(d_int width, d_int height, d_int ticks) {
    Z_Free(y);
    return 0;
}

d_int wipe_StartScreen(d_int x, d_int y, d_int width, d_int height) {
